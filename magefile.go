...
const (
	binaryName   = "import-dates"
	packageName  = "."
	noGitLdflags = "-X github.com/penny-vault/import-dates/common.buildDate=$BUILD_DATE"
)

var ldflags = "-X github.com/penny-vault/import-dates/common.commitHash=$COMMIT_HASH -X github.com/penny-vault/import-dates/common.buildDate=$BUILD_DATE"
...
var (
	pkgPrefixLen = len("github.com/penny-vault/import-dates")
	pkgs         []string
	pkgsInit     sync.Once
)
